...
declare global {
  ...
  const TimeInput: typeof import('/app/workspace/components/TimeInput')['TimeInput']
  ...
  const getAuthenticatedHeaders: typeof import('/app/workspace/utils/config')['getAuthenticatedHeaders']
  ...
  const getYoutubeCookiesForYtdlp: typeof import('/app/workspace/utils/cookies')['getYoutubeCookiesForYtdlp']
  ...
  const secondsToTime: typeof import('/app/workspace/utils/download')['secondsToTime']
